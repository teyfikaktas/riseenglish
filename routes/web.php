...
Route::get('/standard-home', [App\Http\Controllers\HomeController::class, 'index'])
    ->middleware(['auth', EnsurePhoneVerified::class])
    ->name('standard.home');
...
Route::middleware(['auth', EnsurePhoneVerified::class])->group(function () {
...
Route::middleware(['auth', new EnsureUserHasRole('yonetici')])->group(function () {
...
// Öğretmen rotaları
Route::middleware(['auth', new EnsureUserHasRole('ogretmen'), EnsurePhoneVerified::class])->group(function () {
...
// Öğrenci rotaları
Route::middleware(['auth', new EnsureUserHasRole('ogrenci'), EnsurePhoneVerified::class])->group(function () {
