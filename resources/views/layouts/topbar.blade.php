<!-- Improved Navbar with Reduced Spacing -->
<div class="sticky top-0 w-full bg-white shadow-md z-50">
    <div class="container mx-auto px-2 sm:px-4">
        ...
        <div class="hidden lg:flex items-center justify-between h-20 px-2">
            ...
            <div class="flex items-center ml-auto mr-2 space-x-1 text-sm">
                <a href="{{ url('/') }}" class="py-2 px-2 rounded-lg hover:bg-red-50 border border-transparent hover:border-red-200 font-semibold {{ request()->is('/') || request()->is('ana-sayfa') ? 'bg-red-50 border-red-200 text-red-600 font-semibold' : 'text-gray-700' }}">
                    <span class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
                        <span>Ana Sayfa</span>
                    </span>
                </a>
                <a href="{{ route('public.resources.index') }}" class="py-2 px-2 rounded-lg hover:bg-red-50 border border-transparent hover:border-red-200 font-semibold {{ request()->is('ucretsiz-kaynaklar') || request()->is('ucretsiz-kaynaklar/*') ? 'bg-red-50 border-red-200 text-red-600 font-semibold' : 'text-gray-700' }}">
                    <span class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                        <span>Ücretsiz İçerikler</span>
                    </span>
                </a>
                <a href="{{ url('/egitimler') }}" class="py-2 px-2 rounded-lg hover:bg-red-50 border border-transparent hover:border-red-200 font-semibold {{ request()->is('egitimler') || request()->is('egitimler/*') ? 'bg-red-50 border-red-200 text-red-600 font-semibold' : 'text-gray-700' }}">
                    <span class="flex items-center">
                ...
                <a href="{{ url('/iletisim') }}" class="py-2 px-2 rounded-lg hover:bg-red-50 border border-transparent hover:border-red-200 font-semibold {{ request()->is('iletisim') ? 'bg-red-50 border-red-200 text-red-600 font-semibold' : 'text-gray-700' }}">
                    <span class="flex items-center">
                ...
                <a href="{{ route('ogretmen.private-lessons.index') }}" class="py-2 px-2 rounded-lg hover:bg-red-50 border border-transparent hover:border-red-200 font-semibold {{ request()->is('ogretmen/ozel-derslerim') || request()->is('ogretmen/ozel-derslerim/*') ? 'bg-red-50 border-red-200 text-red-600 font-semibold' : 'text-gray-700' }}">
                    <span class="flex items-center">
                ...
                <a href="{{ route('zinciri-kirma') }}" class="py-2 px-2 rounded-lg hover:bg-red-50 border border-transparent hover:border-red-200 font-semibold {{ request()->is('zinciri-kirma') || request()->is('zinciri-kirma/*') ? 'bg-red-50 border-red-200 text-red-600 font-semibold' : 'text-gray-700' }}">
                    <span class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('ogrenci.private-lessons.index') }}" class="py-2 px-2 rounded-lg hover:bg-red-50 border border-transparent hover:border-red-200 font-semibold {{ request()->is('ogrenci/ozel-derslerim') || request()->is('ogrenci/ozel-derslerim/*') ? 'bg-red-50 border-red-200 text-red-600 font-semibold' : 'text-gray-700' }}">
                    <span class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                        <span>Derslerim</span>
                    </span>
            ...
            <div class="flex-shrink-0">
                 @auth
                    @if(auth()->user()->hasRole('ogrenci'))
                        <button id="profile-btn" class="flex items-center space-x-1 p-2 hover:bg-gray-100 rounded-lg focus:outline-none transition-all duration-200">
                        ...
                        <div id="profile-dropdown" class="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg hidden overflow-hidden z-50">
                            <a href="{{ route('ogrenci.settings.index') }}" class="block px-4 py-2 text-gray-700 hover:bg-red-50 hover:text-red-600 transition-colors duration-200">
                            ...
                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="block px-4 py-2 text-gray-700 hover:bg-red-50 hover:text-red-600 transition-colors duration-200">
    ...
    <div class="lg:hidden mobile-menu hidden bg-white border-t shadow-inner">
        <div class="py-2 divide-y divide-gray-100">
            <a href="{{ url('/') }}" class="flex items-center px-4 py-2 hover:bg-red-50 {{ request()->is('/') || request()->is('ana-sayfa') ? 'bg-red-50 border-l-4 border-red-500 pl-3' : '' }}">
            ...
            <a href="{{ route('public.resources.index') }}" class="flex items-center px-4 py-2 hover:bg-red-50 {{ request()->is('ucretsiz-kaynaklar') || request()->is('ucretsiz-kaynaklar/*') ? 'bg-red-50 border-l-4 border-red-500 pl-3' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
            ...
            <a href="{{ url('/egitimler') }}" class="flex items-center px-4 py-2 hover:bg-red-50 {{ request()->is('egitimler') || request()->is('egitimler/*') ? 'bg-red-50 border-l-4 border-red-500 pl-3' : '' }}">
            ...
            <a href="{{ url('/iletisim') }}" class="flex items-center px-4 py-2 hover:bg-red-50 {{ request()->is('iletisim') ? 'bg-red-50 border-l-4 border-red-500 pl-3' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
            ...
            @auth
                ...
                <a href="{{ route('ogretmen.private-lessons.index') }}" class="flex items-center px-4 py-2 hover:bg-red-50 {{ request()->is('ogretmen/ozel-derslerim') || request()->is('ogretmen/ozel-derslerim/*') ? 'bg-red-50 border-l-4 border-red-500 pl-3' : '' }}">
                   <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                ...
                @if(auth()->user()->hasRole('ogrenci'))
                <a href="{{ route('zinciri-kirma') }}" class="flex items-center px-4 py-2 hover:bg-red-50 {{ request()->is('zinciri-kirma') || request()->is('zinciri-kirma/*') ? 'bg-red-50 border-l-4 border-red-500 pl-3' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                    </svg>
                    <span class="font-medium text-gray-700 {{ request()->is('zinciri-kirma') || request()->is('zinciri-kirma/*') ? 'text-red-600' : '' }}">Zinciri Kırma</span>
                </a>

                <a href="{{ route('ogrenci.private-lessons.index') }}" class="flex items-center px-4 py-2 hover:bg-red-50 {{ request()->is('ogrenci/ozel-derslerim') || request()->is('ogrenci/ozel-derslerim/*') ? 'bg-red-50 border-l-4 border-red-500 pl-3' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                ...
                <a href="{{ route('ogrenci.settings.index') }}" class="flex items-center px-4 py-2 hover:bg-red-50 {{ request()->is('ogrenci/ayarlar') ? 'bg-red-50 border-l-4 border-red-500 pl-3' : '' }}">
