...
<head>
    ...
    <title>Oturum Süresi Doldu - Rise English</title>
...
<body class="antialiased min-h-screen bg-gradient-to-r from-[#1a2e5a] to-[#283b6a] py-20 overflow-hidden flex items-center justify-center px-6">
    ...
    <div class="bg-white rounded-xl shadow-xl max-w-lg w-full mx-auto relative z-10 overflow-hidden">
        ...
        <div class="p-8">
            <div class="mb-8 text-center">
                <div class="inline-block p-3 rounded-full bg-red-100 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-14 w-14 text-[#e63946]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
                <h1 class="text-3xl font-bold text-[#1a2e5a] mb-2">Oturum Süresi Doldu</h1>
                <p class="text-gray-600 mb-6">Uzun süre işlem yapılmadığı için güvenlik nedeniyle oturumunuz sonlandırıldı.</p>
                
                <div class="bg-gray-50 rounded-lg p-4 mb-6 border-l-4 border-[#1a2e5a]">
                    <p class="text-gray-700">Sayfayı yenileyerek veya geri dönerek işleminize devam edebilirsiniz.</p>
                </div>
            </div>
        ...
        <div class="py-3 px-4 bg-gray-100 text-center border-t border-gray-200">
            <span class="inline-block text-[#1a2e5a] font-medium">
                <i class="fas fa-shield-alt mr-2"></i>Rise English Güvenlik
            </span>
        </div>
    </div>
    ...
    <div class="absolute bottom-4 right-4 bg-white rounded-lg p-4 shadow-lg hidden sm:block">
        <div class="flex items-center">
            ...
            <span class="font-bold text-[#1a2e5a]">Yeniden giriş yapabilirsiniz</span>
        </div>
    </div>
</body>
</html>