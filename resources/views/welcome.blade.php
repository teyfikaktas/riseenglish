    ...
    <div class="container mx-auto px-6 relative z-10">
      <div class="flex flex-col md:flex-row items-center">
          ...
          <div class="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
            @if(auth()->check() && auth()->user()->hasRole('ogrenci'))
              ...
              <a href="{{ url('/ogrenci/kurslarim') }}" class="bg-[#e63946] hover:bg-[#d62836] text-white font-bold py-4 px-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
                <i class="fas fa-graduation-cap mr-2"></i>Kurslarım
              </a>
              <a href="{{ url('/egitimler') }}" class="bg-white hover:bg-gray-100 text-[#1a2e5a] font-bold py-4 px-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
                <i class="fas fa-book-open mr-2"></i>Eğitimleri Keşfet
              </a>
            @else
        ...
        <div class="w-full md:w-1/2">
            <div class="relative">
              <!-- Ana görsel - Özgürlük Heykeli eklendi -->
              <img src="{{ asset('images/freedom.png') }}" alt="Özgürlük Heykeli" class="w-full h-auto rounded-lg shadow-xl object-cover transform hover:scale-105 transition-transform duration-500">
              ...
              <div class="absolute -bottom-4 -right-4 bg-white rounded-lg p-4 shadow-lg">
                <div class="flex items-center">
                  ...
                  <span class="font-bold text-[#1a2e5a]">10020+ Aktif Öğrenci</span>
                </div>
              </div>
              
              <!-- Büyütülmüş indirim kutusu -->
              @if(!auth()->check() || !auth()->user()->hasRole('ogrenci'))
              <div class="absolute -top-4 -left-4 bg-[#e63946] text-white rounded-lg p-6 shadow-xl transform rotate-3 hover:rotate-0 transition-transform duration-300">
                <div class="text-3xl font-extrabold">%20 İNDİRİM</div>
                <div class="text-lg font-semibold mt-1">İlk Kayıtta</div>
                <div class="text-sm mt-1 bg-white text-[#e63946] px-2 py-1 rounded font-bold inline-block">SINIRLI SÜRE!</div>
              </div>
              @endif
            </div>
          </div>
      ...
      <div class="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
        <div class="bg-white rounded-lg p-4 shadow-lg">
          <div class="text-3xl font-bold text-[#1a2e5a]">100+</div>
          <div class="text-[#1a2e5a]">Eğitim Kursu</div>
        </div>
        <div class="bg-white rounded-lg p-4 shadow-lg">
          <div class="text-3xl font-bold text-[#1a2e5a]">50+</div>
          <div class="text-[#1a2e5a]">Uzman Eğitmen</div>
        </div>
        <div class="bg-white rounded-lg p-4 shadow-lg">
          <div class="text-3xl font-bold text-[#1a2e5a]">5000+</div>
          <div class="text-[#1a2e5a]">Mezun Öğrenci</div>
        </div>
        <div class="bg-white rounded-lg p-4 shadow-lg">
          <div class="text-3xl font-bold text-[#1a2e5a]">4.9/5</div>
          <div class="text-[#1a2e5a]">Memnuniyet Oranı</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="bg-gray-50 py-16">
    <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-12">Neden Rise English?</h2>
