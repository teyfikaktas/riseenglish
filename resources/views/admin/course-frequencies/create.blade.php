...
@section('title', 'Yeni Kurs Frekansı Ekle')
...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Yeni Kurs Frekansı Ekle</h1>
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <form action="{{ route('admin.course-frequencies.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="sessions_per_week" id="sessions_per_week" value="{{ old('sessions_per_week') }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" required>
