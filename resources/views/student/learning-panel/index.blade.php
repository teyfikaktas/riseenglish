...
<!-- Test Geçmişim & Soru Analizi Kutusu (Geçici Disabled) -->
<div class="bg-white rounded-xl shadow-md border border-gray-100 opacity-70 overflow-hidden cursor-not-allowed">
    ...
    <div class="p-4">
        <h3 class="text-lg font-bold text-gray-500 mb-1">Test Geçmişim & Soru Analizi</h3>
        <p class="text-sm text-gray-500">Çözdüğünüz testlerin sonuçlarını, analizlerini ve soru bazlı performansınızı görüntüleyin.</p>
    </div>
</div>
