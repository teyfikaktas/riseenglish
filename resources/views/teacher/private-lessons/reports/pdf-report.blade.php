...
.bottom-left-decoration {
    bottom: 0;
    left: 0;
    border-bottom: 10px solid #1a2e5a;
    border-left: 10px solid #1a2e5a;
...
<body>
    ...
    <div class="report-container">
        ...
        @if($report->pros)
        <div class="section">
            <div class="section-title"><i class="fas fa-plus-circle"></i>Artıları</div>
        ...
        @if($report->cons)
        <div class="section">
            <div class="section-title"><i class="fas fa-minus-circle"></i>Eksileri</div>
            <div class="content-box">
                {!! nl2br(e($report->cons)) !!}
            </div>
        </div>
