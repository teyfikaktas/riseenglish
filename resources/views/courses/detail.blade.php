                                        ...
                                        <div class="ml-7">
                                            ...
                                            {{-- @if($course->meeting_password)
                                                <div class="bg-blue-50 p-3 rounded-lg border border-blue-200 mb-2">
                                                    <span class="text-blue-700 font-medium">Toplantı Şifresi:</span> 
                                                    <span class="font-mono bg-white px-2 py-1 rounded border border-blue-200 text-blue-700">{{ $course->meeting_password }}</span>
                                                </div>
                                            @endif
                                            <div class="mt-4">
